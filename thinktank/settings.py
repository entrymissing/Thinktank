...
DATABASES = {
    'default': {
        ...
        'NAME': '/var/www/Thinktank/thinktank.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'lfip&xxye(nmbmk$88y$g16&0e+vb1s2_0ny=v$z9!%96bt*p+'
...
#setting the auth profile to the User Profile
AUTH_PROFILE_MODULE = 't3manager.UserProfile'
